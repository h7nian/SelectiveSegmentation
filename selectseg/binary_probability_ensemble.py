...
SOURCE_LOCK_ARTIFACT_TYPE = "selectseg.binary_probability_ensemble_source_lock"
...
def _source_fingerprint() -> str:
    ...
    relative_paths = (
        ...
        "selectseg/binary_probability_ensemble.py",
...
def build_ensemble_artifact(args, argv=None) -> Path:
    ...
    return write_binary_artifact(
        ...
        command=[
            "python",
            "-m",
            "selectseg.binary_probability_ensemble",
            *command_argv,
        ],
