...
def load_spec_lock(path=DEFAULT_SPEC_LOCK, *, expected_sha256=None):
    ...
    source_paths = {entry["path"] for entry in lock["source_files"]}
    current_sources = {
        "selectseg/train.py",
        "selectseg/data.py",
        "selectseg/models.py",
    ...
    if source_paths not in (current_sources, historical_sources):
...
def run_freeze(
    ...
    *,
    ...
    from selectseg.pipeline.freeze import main as freeze_main
