...
import numpy as np
import pytest
import selectseg.score_binary_simulation as scorer_module
import selectseg.score_binary_common as common_module
...
from selectseg.binary_eval import binary_record
