...
\noindent\textbf{Robust extension: pooled nHD95.}
...
\end{equation*}
Thus Dice and nHD instantiate the \textbf{same Lipschitz--Wasserstein template} under
...
\noindent\textbf{Why SDC remains strong for Dice.}
