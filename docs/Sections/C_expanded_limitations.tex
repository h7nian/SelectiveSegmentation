...
simultaneous family-wise-error guarantee. With one fixed training seed they also do not include
...
independent images. Release-level patient, video, or eye identifiers are not
available uniformly across the five cohorts, so the intervals should not be read
as patient-clustered evidence.
