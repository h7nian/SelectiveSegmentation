...
checkpoint-level variation descriptively; three seeds neither estimate the full
distribution of training randomness nor add optimization or training-sample
variation to the primary intervals. Repeated training runs at larger scale and
external-site validation would be needed for that broader claim. Moreover, model
