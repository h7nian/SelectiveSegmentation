...
from scripts.submit.main import load_campaign_lock as validate_lock
from selectseg.artifacts import fsync_directory, publish_directory_no_replace
...
def _assembly_source_sha256():
    ...
    paths = (
        ...
        root / "selectseg" / "pipeline" / "common.py",
        root / "selectseg" / "pipeline" / "score.py",
    ...
    manifest.update(
        {
            ...
            "command": ["python", "-m", "scripts.assemble"],
            "assembly": {
                **identity,
