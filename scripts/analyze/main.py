...
Example::
    ...
    python scripts/analyze/main.py --input-dir outputs/binary \
...
from selectseg.confidence import (  # noqa: E402
    summarize_aurc,
...
def _analysis_source_sha256() -> str:
    ...
    paths = (Path(__file__).resolve(), REPO_ROOT / "selectseg/confidence.py")
    digest = hashlib.sha256()
    for path in paths:
