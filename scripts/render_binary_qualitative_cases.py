...
Run this only after :mod:`scripts.select_binary_qualitative_cases` has published
...
def _source_sha256() -> str:
    paths = (
        ...
        REPO_ROOT / "scripts/select_binary_qualitative_cases.py",
        REPO_ROOT / "selectseg/binary_artifacts.py",
    )
