...
from scripts.submit_binary_simulations import GPU_ACCOUNT, PlannedJob, execute_plan
from scripts.analyze_synthetic_posterior import (
    ...
    *,
    ...
    for index, cell in enumerate(cells):
        ...
        command = (
            ...
            "--parsable",
            "--job-name",
            f"selseg-syn-{cell.coupling[:8]}-{cell.sharpness[:3]}-"
            f"{cell.morphology[:5]}-r{cell.replicate:02d}"[:128],
            "--partition",
            partition,
            "--account",
            GPU_ACCOUNT,
