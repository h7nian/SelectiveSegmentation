...
from scripts.analyze_binary import CONTRASTS, METHODS, RISKS, load_condition
...
from selectseg.binary_framework import summarize_aurc
from selectseg.binary_seed_downstream import load_downstream_lock
from selectseg.binary_seed_extension import _atomic_write_new, _load_json, _sha256
...
def _analysis_source_sha256():
    ...
    paths = (
        ...
        root / "scripts" / "assemble_binary_simulations.py",
        root / "scripts" / "submit_binary_simulations.py",
        root / "selectseg" / "binary_framework.py",
        root / "selectseg" / "binary_seed_downstream.py",
    )
